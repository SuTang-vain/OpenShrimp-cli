...
OpenShrimp - A unified CLI and Desktop UI tool for managing AI development tools (Claude, Gemini, OpenCode) on macOS and Linux. Built with Go (Cobra) + Tauri + Vue 3.
